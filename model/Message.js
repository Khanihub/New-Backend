...
// Your .env has VITE_API with /api already, so remove the duplicate
const API_BASE = (import.meta.env.VITE_API || 'http://localhost:5000/api').replace(/\/api$/, '')
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/messages`, {
        ...
        body: JSON.stringify({
          matchId: selectedChat, // Backend expects matchId, not chatId
